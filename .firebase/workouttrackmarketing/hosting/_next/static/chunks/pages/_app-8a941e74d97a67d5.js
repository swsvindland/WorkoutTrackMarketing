 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function _({appConfig:e,heartbeatServiceProvider:t},{fid:n}){let r=w(e),i=I(e),a=t.getImmediate({optional:!0});if(a){let o=await a.getHeartbeatsHeader();o&&i.append("x-firebase-client",o)}let s={fid:n,authVersion:m,appId:e.appId,sdkVersion:p},l={method:"POST",headers:i,body:JSON.stringify(s)},c=await E(()=>fetch(r,l));if(c.ok){let u=await c.json(),d={fid:u.fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:v(u.authToken)};return d}throw await y("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function z({appConfig:e,heartbeatServiceProvider:t},n){let r=function(e,{fid:t}){return`${w(e)}/${t}/authTokens:generate`}(e,n),i=function(e,{refreshToken:t}){let n=I(e);return n.append("Authorization",`${m} ${t}`),n}(e,n),a=t.getImmediate({optional:!0});if(a){let o=await a.getHeartbeatsHeader();o&&i.append("x-firebase-client",o)}let s={installation:{sdkVersion:p,appId:e.appId}},l={method:"POST",headers:i,body:JSON.stringify(s)},c=await E(()=>fetch(r,l));if(c.ok){let u=await c.json(),d=v(u);return d}throw await y("Generate Auth Token",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
